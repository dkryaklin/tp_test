	...
	(function () {
	    ...
	    function resizeElem(elem) {
	        if (elem.contentWindow.document.documentElement !== null && elem.contentWindow.document.body !== null) {
	            ...
	            var bodyScrollHeight = elem.contentWindow.document.body.scrollHeight;
	            var docScrollHeight = elem.contentWindow.document.documentElement.scrollHeight;
	    ...
	    function handleOnload() {
	        var elems = getElemsByInitStatus(false);
	    ...
	    function handleResize() {
	        ...
	        window.addEventListener('resize', function () {
	            ...
	            var elems = getElemsByInitStatus(true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(/*! ./../process/browser.js */ 7)))
